        ...
        <div class="table-responsive">
            <form action="{{route('payment')}}" id="create_form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="order_id" name="order_id" type="text" value="{{$orders->id}}" />
                </div>
                <div class="form-group">
                    <label for="amount">Số tiền</label>
                    <input class="form-control" id="amount" name="amount" type="number" value="{{$orders->price}}" />
                </div>
                <div class="form-group">
